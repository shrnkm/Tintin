...
public class DialogueWithDa : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        dialogueList.Add("Hi, Ms. Da! Mind if I ask you a couple of questions?");
        dialogueList.Add("Da: Okay.");
        treeDic.Add(0, dialogueList);
        dialogueList.Add("When did you left the Diamondhaus?");
        dialogueList.Add("Da: Around 9 pm.");
        treeDic.Add(1, dialogueList.GetRange(2, 2));
        dialogueList.Add("Did Ry steal The Blue?");
        dialogueList.Add("Da: Yes.");
        treeDic.Add(2, dialogueList.GetRange(4, 2));
        dialogueList.Add("How were you informed of The Blue being stolen?");
        dialogueList.Add("Da: I heard about it on the Evening News.");
    ...
    public void OnTriggerStay(Collider other)
    {
        ...
        {
            preTintin.text = ("Wanna talk with Da?");
            DaText.text = "";
    ...
    public void DialogueManager()
    {
        ...
        DaText.text = treeDic[_treeLevel][1];
